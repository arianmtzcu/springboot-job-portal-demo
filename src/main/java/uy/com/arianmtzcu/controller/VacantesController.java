...
public class VacantesController {
	...
	public String mostrarIndex(Model model) {		
		...
		// TODO 3. Renderizar las vacantes en la vista (integrar el archivo template-empleos/listaVacantes.html)
		// TODO 4. Agregar al menú una opción llamda "Vacantes" configurando la URL "/vacantes/index"
	...
	public String guardar(@RequestParam("nombre") String nombre, @RequestParam("descripcion") String descripcion, 
			@RequestParam("categoria") String categoria, @RequestParam("estatus") String estatus, @RequestParam("fecha") String fecha,
	...
	public String guardar(Vacante vacante, BindingResult result, RedirectAttributes attributes) {
		//BindingResult result ---> Para hacer el tratamiento de errores durante el Data Binding...
		if(result.hasErrors()) {
		...
		//Flash Attribute ---> Guarda el valor en la sesion hasta que se hace el redirect, por eso cuando se recarga la pagina se pierden los valores guardados...
		attributes.addFlashAttribute("msg","Registro guardado");
		
		System.out.println("Vacante: " + vacante);
		//return "vacantes/listVacantes";	//Redirecciona a la vista, pero no carga las vacantes
		return "redirect:/vacantes/index";
	}	
	
	/*Configuración de  Data Binding (obtención de datos y seteo a objetos de tipo Vacante en este caso!)
	 * Metodo que configura el tema del formato de fecha String al intentar
	 * convertir el atributo a Date*/
	@InitBinder 
